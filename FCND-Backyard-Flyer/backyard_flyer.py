...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            ...
            if abs(self.local_position[0] - self.target_position[0]) < 0.1 and abs(self.local_position[1] - self.target_position[1]) < 0.1:
    ...
    def calculate_box(self):
        ...
        """
        return [(10, 0, 3, 0), (10, 10, 3, 0), (0, 10, 3, 0), (0, 0, 3, 0)]
